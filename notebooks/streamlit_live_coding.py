...
mpg_df = deepcopy(mpg_df_raw) #needed to leave a copy of the entire dataset in the cache. We can play with this and leave the whole data set alone in the cache. 
